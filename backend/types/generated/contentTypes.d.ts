...
export interface ApiContactSubmissionContactSubmission
  ...
  attributes: {
    ...
    status: Schema.Attribute.Enumeration<
      ['nieuw', 'in_behandeling', 'beantwoord', 'gesloten']
    > &
    ...
    > &
      Schema.Attribute.DefaultTo<'algemene_vraag'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiFaqItemFaqItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['bestellen', 'betalen', 'menu', 'catering', 'overig']
    > &
      Schema.Attribute.DefaultTo<'overig'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiMenuCategoryMenuCategory
  ...
  info: {
    description: 'Groups of menu items (e.g. Lahmacun, Pide, Mezze)';
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global site configuration: contact info, social links, etc.';
  ...
  attributes: {
    ...
    btw_number: Schema.Attribute.String;
    ...
    whatsapp_phone: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'31612345678'>;
  };
}
